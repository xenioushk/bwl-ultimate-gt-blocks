...
export default function Edit({ attributes, setAttributes }) {
  ...
  // Get all the poll.
  // wp.data.select("core").getEntityRecords("postType","bwl_poll", {"per_page": -1})
  ...
  return (
    ...
    >
      ...
      <div className="bpm-gt-editor-preview" dangerouslySetInnerHTML={{ __html: petitionsPreview }}></div>
    </div>
  )
}
